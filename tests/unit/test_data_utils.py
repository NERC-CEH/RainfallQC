...
def test_convert_daily_data_to_monthly(daily_gdsr_data, daily_gpcc_data, hourly_gdsr_data):
    result = data_utils.convert_daily_data_to_monthly(daily_gdsr_data, rain_col=DEFAULT_RAIN_COL)
    ...
    result = data_utils.convert_daily_data_to_monthly(
        daily_gpcc_data, rain_col=DEFAULT_RAIN_COL, perc_for_valid_month=99
    )
    ...
    with pytest.raises(ValueError):
        data_utils.convert_daily_data_to_monthly(hourly_gdsr_data, rain_col=DEFAULT_RAIN_COL)
