...
def test_check_for_negative_values(daily_gdsr_data):
    result = data_utils.check_for_negative_values(daily_gdsr_data, target_gauge_col=DEFAULT_RAIN_COL)
    assert result is False
    daily_gdsr_data_with_neg = daily_gdsr_data.with_columns(pl.col(DEFAULT_RAIN_COL) * -1)
    result = data_utils.check_for_negative_values(daily_gdsr_data_with_neg, target_gauge_col=DEFAULT_RAIN_COL)
